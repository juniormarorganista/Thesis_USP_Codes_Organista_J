...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine exact_solutions_case_14(t)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine source_term_case_14(t)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine boundaries_condictions_case_14(t)
     ...
     &             27.d0*psi(imax-2,:)+4.d0*psi(imax-3,:))/(18.d0*dxx)
      ...
      do j = 1, jmax, jmax - 1
         ...
         ux(i,jmax) = 8.0d0*0.1*((1.0d0 - x**2)**2)*(x**2)*
     &  (1 + DTanh(8.0d0*t - 4.0d0)) 
